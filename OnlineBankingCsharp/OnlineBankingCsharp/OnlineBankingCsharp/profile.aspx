<%@ Page Title="Profile - Customer" Language="C#" MasterPageFile="~/Customer.Master" AutoEventWireup="true" CodeBehind="profile.aspx.cs" Inherits="OnlineBankingCsharp.profile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h3 class="mt-4">Customers Profile - Update </h3>
        ...
        <div class="row">
           ...
           <div class="col-xl-4 col-md-6">
                 <div class="form-group">
                      ...
                      <asp:TextBox runat="server" ID="txtMobileNo" type="number" CssClass="form-control"></asp:TextBox>
                 </div>
            </div>
            <div class="col-xl-4 col-md-6">
                 <div class="form-group">
             ...
             <div class="row">
                  <div class="col-xl-4 col-md-6">
                     <div class="form-group">
                          ...
                          <asp:TextBox runat="server" ID="txtEmail" CssClass="form-control" type="email"></asp:TextBox>
                     </div>
                </div>
                <div class="col-xl-4 col-md-6">
                 <div class="form-group">
